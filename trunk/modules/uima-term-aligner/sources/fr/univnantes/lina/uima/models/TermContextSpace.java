...
public interface TermContextSpace extends SharedResourceObject {
	...
	public void doCheck(String indexID, Map<String, Set<String>> translations) throws Exception;
	...
	public void doCompare(String sourceID, String targetID) throws Exception;
