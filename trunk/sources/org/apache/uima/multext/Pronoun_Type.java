...
public class Pronoun_Type extends MultextAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.multext.Pronoun");
 
  /** @generated */
  final Feature casFeat_pronounType;
  /** @generated */
  final int     casFeatCode_pronounType;
  /** @generated */ 
  public String getPronounType(int addr) {
        if (featOkTst && casFeat_pronounType == null)
      jcas.throwFeatMissing("pronounType", "org.apache.uima.multext.Pronoun");
    return ll_cas.ll_getStringValue(addr, casFeatCode_pronounType);
  }
  /** @generated */    
  public void setPronounType(int addr, String v) {
        if (featOkTst && casFeat_pronounType == null)
      jcas.throwFeatMissing("pronounType", "org.apache.uima.multext.Pronoun");
    ll_cas.ll_setStringValue(addr, casFeatCode_pronounType, v);}
  ...
  public String getPerson(int addr) {
      ...
      jcas.throwFeatMissing("person", "org.apache.uima.multext.Pronoun");
  ...
  public String getNumber(int addr) {
      ...
      jcas.throwFeatMissing("number", "org.apache.uima.multext.Pronoun");
  ...
  public String getGender(int addr) {
      ...
      jcas.throwFeatMissing("gender", "org.apache.uima.multext.Pronoun");
  ...
  public String getCase(int addr) {
      ...
      jcas.throwFeatMissing("case", "org.apache.uima.multext.Pronoun");
  ...
  public String getPossessor(int addr) {
      ...
      jcas.throwFeatMissing("possessor", "org.apache.uima.multext.Pronoun");
  ...
  public Pronoun_Type(JCas jcas, Type casType) {
    ...
    casFeat_pronounType = jcas.getRequiredFeatureDE(casType, "pronounType", "uima.cas.String", featOkTst);
    casFeatCode_pronounType  = (null == casFeat_pronounType) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_pronounType).getCode();
