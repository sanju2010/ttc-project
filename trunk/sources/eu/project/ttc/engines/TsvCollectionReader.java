...
public class TsvCollectionReader extends CollectionReader_ImplBase {
	...
	private void populate(JCas cas,File file) throws IOException {
		...
		while (scanner.hasNext()) {
			...
			if (items.length >= 3) {
				...
				throw new IOException("In file: " + file.getAbsolutePath() + "\nWrong TSV format at line n°" + index + ": " + line);
			}
		}
