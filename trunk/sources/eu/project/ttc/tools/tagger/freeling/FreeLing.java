...
public class FreeLing implements TaggerTool {
	...
	private FreeLingSettings settings;
	
	private void setSettings() {
		this.settings = new FreeLingSettings(System.getProperty("user.home") + File.separator + ".freeling.settings");
	}
	 ...
	 */
	@Override
	public FreeLingSettings getSettings() {
	...
	private void setPreferences() {
		this.preferences = new Preferences("freeling.properties");
		try {
