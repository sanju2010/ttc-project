...
public class TildeTagger implements Runnable {
	...
	private TildeTaggerSettings settings;
	
	private void setSettings() {
		this.settings = new TildeTaggerSettings(System.getProperty("user.home") + File.separator + ".tildetagger.settings");
	}
	
	public TildeTaggerSettings getSettings() {
	...
	private void setPreferences() {
		this.preferences = new Preferences("tildetagger.properties");
		try {
	...
	public TildeTagger(boolean cli) {
	...
	private void enableListeners() {
		TildeTaggerEngineListener acabitEngineListener = new TildeTaggerEngineListener();
		acabitEngineListener.setTildeTagger(this);
	...
	private void process() {
		TildeTaggerEngineListener engineListener = new TildeTaggerEngineListener();
		engineListener.setTildeTagger(this);
	...
	public static void main(String[] args) {
		...
		if (wrong == null) {
			TildeTagger treeTagger = new TildeTagger(cli);
	...
	private class WindowListener extends WindowAdapter {
		...
		private TildeTagger treeTagger;
		
		public void setTreeTagger(TildeTagger treeTagger) {
			this.treeTagger = treeTagger;
		}
		
		private TildeTagger getTreeTagger() {
