...
/**
 * A Swing component that automatically build a Panel to display configuration parameters
 * as based on a {@link TermSuiteToolSettings}.
 */
public class SettingsPanel extends JPanel {

    /**
     * Constructor. Build the interface based on the settings passed in parameter
     * of the constructor.
     *
     * @param settings
     *      the settings this panel should expose
     */
    public SettingsPanel(TermSuiteToolSettings settings) {
        super();
	...
	private void addDisableListener(final JCheckBox checkbox,
		...
		checkbox.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				Field field;
				for (String f : fields) {
					field = SettingsPanel.this.fields.get(f);
