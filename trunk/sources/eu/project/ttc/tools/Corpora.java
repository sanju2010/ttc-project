...
public class Corpora {
	...
	static {
		languages = new TreeMap<String,Locale>();
		...
		languages.put(Locale.GERMAN.getDisplayName(Locale.ENGLISH),Locale.GERMAN);
		languages.put(Locale.CHINESE.getDisplayName(Locale.ENGLISH),Locale.CHINESE);
		languages.put(RUSSIAN.getDisplayName(Locale.ENGLISH),RUSSIAN);
		languages.put(SPANISH.getDisplayName(Locale.ENGLISH),SPANISH);
	}
	...
	public void setLanguage(String language) {
		...
		this.getComboBoxModel().setSelectedItem(locale.getDisplayName(Locale.ENGLISH));
	}
	...
	public void addCorpus(File file) {
		Corpus corpus = new Corpus(file);
		this.getModel().addElement(corpus);
	}
	...
	private void setComponent() {
		...
		this.component.setOrientation(JSplitPane.VERTICAL_SPLIT);
		this.component.setTopComponent(this.getComboBox());
		this.component.setBottomComponent(this.getScroll());
		this.component.setEnabled(false);
		this.component.setResizeWeight(1.0);
	}
