...
public class XmiTbxConverter implements ConverterTool {
	...
	private void setSettings() {
		this.settings = new XmiTbxConverterSettings(System.getProperty("user.home") + File.separator + ".converter-xmi-tbx.settings");
	}
