...
public class XmiCsvConverter implements ConverterTool {
	...
	private XmiCsvConverterSettings settings;
	
	private void setSettings() {
		this.settings = new XmiCsvConverterSettings(System.getProperty("user.home") + File.separator + ".converter-xmi-csv.settings");
	}
	 ...
	 */
	@Override
	public XmiCsvConverterSettings getSettings() {
