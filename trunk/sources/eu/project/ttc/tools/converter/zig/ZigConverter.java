...
public class ZigConverter implements ConverterTool {
	...
	private ZigConverterSettings settings;
	
	private void setSettings() {
		this.settings = new ZigConverterSettings(System.getProperty("user.home") + File.separator + ".converter-zig.settings");
	}
	 ...
	 */
	@Override
	public ZigConverterSettings getSettings() {
