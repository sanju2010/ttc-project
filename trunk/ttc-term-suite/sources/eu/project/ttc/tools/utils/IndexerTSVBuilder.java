...
public class IndexerTSVBuilder extends AbstractTSVBuilder {
	 ...
	 *            The output writer.
	 */
	public IndexerTSVBuilder(Writer out) {
		super(out);
	}

	public void startTerm(String term) throws IOException {
		append(Integer.toString(termCount), "T", term);
	}

	public void addVariant(String variant) throws IOException {
		append(Integer.toString(termCount), "V", variant);
	}
