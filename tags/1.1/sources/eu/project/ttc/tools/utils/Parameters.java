...
public abstract class Parameters {
	...
	protected void addParameter(ConfigurationParameterDeclarations declarations,String name,String type,boolean multiValued,boolean mandatory) {
	...
	public void doSave() throws IOException, SAXException {
		this.doUpdate();
		// String path = System.getProperty("user.home") + File.separator + "." + this.getResource();
